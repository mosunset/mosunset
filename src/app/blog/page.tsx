    ...
    return (
        <>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {totalblog == 0 ? (
                    <>
                        <div className="group flex min-h-max flex-col rounded-xl  px-4 py-3 transition-all ">
                            <Skeleton className="aspect-w-16 aspect-h-10 aspect-video w-full rounded-xl object-cover shadow-sm" />
                            <div className="mt-3 space-y-2 text-xl">
